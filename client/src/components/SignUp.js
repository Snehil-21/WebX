          ...
          <div className={classes.body}>
              <div className={classes.inDiv}>
                  ...
                  <form className={classes.root} noValidate autoComplete="off">
                      ...
                      <TextField id="outlined-basic" label="Password" autoComplete='on' variant="outlined" type="password" className={classes.textfield} value={password} onChange={(event) => setPassword(event.target.value)} />
                      <TextField id="outlined-basic" label="Confirm Password" autoComplete='on' variant="outlined" type="password" className={classes.textfield} value={confPass} onChange={(event) => setConfPass(event.target.value)} />
